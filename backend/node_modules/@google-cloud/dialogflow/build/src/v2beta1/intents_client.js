...
class IntentsClient {
    ...
    constructor(opts) {
        ...
        this.descriptors.page = {
            listIntents: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'intents'),
        };
        ...
        const batchUpdateIntentsResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.v2beta1.BatchUpdateIntentsResponse');
        const batchUpdateIntentsMetadata = protoFilesRoot.lookup('.google.protobuf.Struct');
        const batchDeleteIntentsResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const batchDeleteIntentsMetadata = protoFilesRoot.lookup('.google.protobuf.Struct');
        this.descriptors.longrunning = {
            batchUpdateIntents: new this._gaxModule.LongrunningDescriptor(this.operationsClient, batchUpdateIntentsResponse.decode.bind(batchUpdateIntentsResponse), batchUpdateIntentsMetadata.decode.bind(batchUpdateIntentsMetadata)),
            batchDeleteIntents: new this._gaxModule.LongrunningDescriptor(this.operationsClient, batchDeleteIntentsResponse.decode.bind(batchDeleteIntentsResponse), batchDeleteIntentsMetadata.decode.bind(batchDeleteIntentsMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.v2beta1.Intents', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.intentsStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.dialogflow.v2beta1.Intents')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dialogflow.v2beta1.Intents, this._opts);
        ...
        for (const methodName of intentsStubMethods) {
            const callPromise = this.intentsStub.then(stub => (...args) => {
                if (this._terminated) {
     ...
     */
    getIntent(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    createIntent(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    updateIntent(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    deleteIntent(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    batchUpdateIntents(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *
     */
    async checkBatchUpdateIntentsProgress(name) {
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    batchDeleteIntents(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *
     */
    async checkBatchDeleteIntentsProgress(name) {
        const request = new google_gax_1.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    listIntents(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listIntentsStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.listIntents.createStream(this.innerApiCalls.listIntents, request, callSettings);
    }
    /**
    ...
    listIntentsAsync(request, options) {
        ...
        const callSettings = new gax.CallSettings(options);
        this.initialize();
        return this.descriptors.page.listIntents.asyncIterate(this.innerApiCalls['listIntents'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
//# sourceMappingURL=intents_client.js.map