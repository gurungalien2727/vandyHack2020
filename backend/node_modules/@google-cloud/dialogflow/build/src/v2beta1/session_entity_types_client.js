...
exports.SessionEntityTypesClient = void 0;
...
class SessionEntityTypesClient {
    ...
    constructor(opts) {
        ...
        this.descriptors.page = {
            listSessionEntityTypes: new this._gaxModule.PageDescriptor('pageToken', 'nextPageToken', 'sessionEntityTypes'),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.v2beta1.SessionEntityTypes', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.sessionEntityTypesStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.dialogflow.v2beta1.SessionEntityTypes')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dialogflow.v2beta1
                    .SessionEntityTypes, this._opts);
        ...
        for (const methodName of sessionEntityTypesStubMethods) {
            const callPromise = this.sessionEntityTypesStub.then(stub => (...args) => {
                if (this._terminated) {
     ...
     */
    getSessionEntityType(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    createSessionEntityType(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    updateSessionEntityType(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    deleteSessionEntityType(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    listSessionEntityTypes(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
    ...
    listSessionEntityTypesStream(request, options) {
        ...
        this.initialize();
        return this.descriptors.page.listSessionEntityTypes.createStream(this.innerApiCalls.listSessionEntityTypes, request, callSettings);
    }
    /**
     ...
     */
    listSessionEntityTypesAsync(request, options) {
        request = request || {};
        options = options || {};
        options.otherArgs = options.otherArgs || {};
        options.otherArgs.headers = options.otherArgs.headers || {};
        ...
        const callSettings = new gax.CallSettings(options);
        this.initialize();
        return this.descriptors.page.listSessionEntityTypes.asyncIterate(this.innerApiCalls['listSessionEntityTypes'], request, callSettings);
    }
    // --------------------
    // -- Path templates --
    // --------------------
...
//# sourceMappingURL=session_entity_types_client.js.map