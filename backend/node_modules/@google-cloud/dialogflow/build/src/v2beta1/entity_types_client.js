...
class EntityTypesClient {
    ...
    constructor(opts) {
        ...
        const batchUpdateEntityTypesResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.v2beta1.BatchUpdateEntityTypesResponse');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.v2beta1.EntityTypes', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.entityTypesStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.dialogflow.v2beta1.EntityTypes')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dialogflow.v2beta1.EntityTypes, this._opts);
