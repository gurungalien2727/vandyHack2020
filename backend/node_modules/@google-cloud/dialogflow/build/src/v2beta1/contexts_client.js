...
class ContextsClient {
    ...
    constructor(opts) {
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.v2beta1.Contexts', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.contextsStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.dialogflow.v2beta1.Contexts')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dialogflow.v2beta1.Contexts, this._opts);
        ...
        for (const methodName of contextsStubMethods) {
            const callPromise = this.contextsStub.then(stub => (...args) => {
                if (this._terminated) {
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    deleteAllContexts(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
...
//# sourceMappingURL=contexts_client.js.map