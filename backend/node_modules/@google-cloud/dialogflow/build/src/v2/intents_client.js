...
class IntentsClient {
    ...
    constructor(opts) {
        ...
        const batchUpdateIntentsResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.v2.BatchUpdateIntentsResponse');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.v2.Intents', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.intentsStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.dialogflow.v2.Intents')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dialogflow.v2.Intents, this._opts);
