...
class AgentsClient {
    ...
    constructor(opts) {
        ...
        const exportAgentResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.v2beta1.ExportAgentResponse');
        ...
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.v2beta1.Agents', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.agentsStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.dialogflow.v2beta1.Agents')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dialogflow.v2beta1.Agents, this._opts);
