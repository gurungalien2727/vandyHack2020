...
class DocumentsClient {
    ...
    constructor(opts) {
        ...
        // pass `{fallback: true}` to the DocumentsClient constructor.
        ...
        const createDocumentResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.v2beta1.Document');
        const createDocumentMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.v2beta1.KnowledgeOperationMetadata');
        const deleteDocumentResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const deleteDocumentMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.v2beta1.KnowledgeOperationMetadata');
        const updateDocumentResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.v2beta1.Document');
        const updateDocumentMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.v2beta1.KnowledgeOperationMetadata');
        const reloadDocumentResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.v2beta1.Document');
        const reloadDocumentMetadata = protoFilesRoot.lookup('.google.cloud.dialogflow.v2beta1.KnowledgeOperationMetadata');
        this.descriptors.longrunning = {
            createDocument: new this._gaxModule.LongrunningDescriptor(this.operationsClient, createDocumentResponse.decode.bind(createDocumentResponse), createDocumentMetadata.decode.bind(createDocumentMetadata)),
            deleteDocument: new this._gaxModule.LongrunningDescriptor(this.operationsClient, deleteDocumentResponse.decode.bind(deleteDocumentResponse), deleteDocumentMetadata.decode.bind(deleteDocumentMetadata)),
            updateDocument: new this._gaxModule.LongrunningDescriptor(this.operationsClient, updateDocumentResponse.decode.bind(updateDocumentResponse), updateDocumentMetadata.decode.bind(updateDocumentMetadata)),
            reloadDocument: new this._gaxModule.LongrunningDescriptor(this.operationsClient, reloadDocumentResponse.decode.bind(reloadDocumentResponse), reloadDocumentMetadata.decode.bind(reloadDocumentMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.v2beta1.Documents', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.documentsStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.dialogflow.v2beta1.Documents')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dialogflow.v2beta1.Documents, this._opts);
        ...
        for (const methodName of documentsStubMethods) {
            const callPromise = this.documentsStub.then(stub => (...args) => {
                if (this._terminated) {
     ...
     *
     */
    async checkCreateDocumentProgress(name) {
        const request = new google_gax_1.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.createDocument, gax.createDefaultBackoffSettings());
     ...
     *
     */
    async checkDeleteDocumentProgress(name) {
        const request = new google_gax_1.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.deleteDocument, gax.createDefaultBackoffSettings());
        return decodeOperation;
    }
    /**
     ...
     *
     */
    async checkUpdateDocumentProgress(name) {
        const request = new google_gax_1.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.updateDocument, gax.createDefaultBackoffSettings());
        return decodeOperation;
    }
    /**
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    reloadDocument(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *
     */
    async checkReloadDocumentProgress(name) {
        const request = new google_gax_1.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
        const decodeOperation = new gax.Operation(operation, this.descriptors.longrunning.reloadDocument, gax.createDefaultBackoffSettings());
        return decodeOperation;
    }
    /**
...
//# sourceMappingURL=documents_client.js.map