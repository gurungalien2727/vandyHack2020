...
exports.EntityTypesClient = void 0;
...
class EntityTypesClient {
    ...
    constructor(opts) {
        ...
        // pass `{fallback: true}` to the EntityTypesClient constructor.
        ...
        const batchUpdateEntityTypesResponse = protoFilesRoot.lookup('.google.cloud.dialogflow.v2.BatchUpdateEntityTypesResponse');
        const batchUpdateEntityTypesMetadata = protoFilesRoot.lookup('.google.protobuf.Struct');
        const batchDeleteEntityTypesResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const batchDeleteEntityTypesMetadata = protoFilesRoot.lookup('.google.protobuf.Struct');
        const batchCreateEntitiesResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const batchCreateEntitiesMetadata = protoFilesRoot.lookup('.google.protobuf.Struct');
        const batchUpdateEntitiesResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const batchUpdateEntitiesMetadata = protoFilesRoot.lookup('.google.protobuf.Struct');
        const batchDeleteEntitiesResponse = protoFilesRoot.lookup('.google.protobuf.Empty');
        const batchDeleteEntitiesMetadata = protoFilesRoot.lookup('.google.protobuf.Struct');
        this.descriptors.longrunning = {
            batchUpdateEntityTypes: new this._gaxModule.LongrunningDescriptor(this.operationsClient, batchUpdateEntityTypesResponse.decode.bind(batchUpdateEntityTypesResponse), batchUpdateEntityTypesMetadata.decode.bind(batchUpdateEntityTypesMetadata)),
            batchDeleteEntityTypes: new this._gaxModule.LongrunningDescriptor(this.operationsClient, batchDeleteEntityTypesResponse.decode.bind(batchDeleteEntityTypesResponse), batchDeleteEntityTypesMetadata.decode.bind(batchDeleteEntityTypesMetadata)),
            batchCreateEntities: new this._gaxModule.LongrunningDescriptor(this.operationsClient, batchCreateEntitiesResponse.decode.bind(batchCreateEntitiesResponse), batchCreateEntitiesMetadata.decode.bind(batchCreateEntitiesMetadata)),
            batchUpdateEntities: new this._gaxModule.LongrunningDescriptor(this.operationsClient, batchUpdateEntitiesResponse.decode.bind(batchUpdateEntitiesResponse), batchUpdateEntitiesMetadata.decode.bind(batchUpdateEntitiesMetadata)),
            batchDeleteEntities: new this._gaxModule.LongrunningDescriptor(this.operationsClient, batchDeleteEntitiesResponse.decode.bind(batchDeleteEntitiesResponse), batchDeleteEntitiesMetadata.decode.bind(batchDeleteEntitiesMetadata)),
        };
        // Put together the default options sent with requests.
        this._defaults = this._gaxGrpc.constructSettings('google.cloud.dialogflow.v2.EntityTypes', gapicConfig, opts.clientConfig || {}, { 'x-goog-api-client': clientHeader.join(' ') });
    ...
    initialize() {
        ...
        this.entityTypesStub = this._gaxGrpc.createStub(this._opts.fallback
            ? this._protos.lookupService('google.cloud.dialogflow.v2.EntityTypes')
            : // eslint-disable-next-line @typescript-eslint/no-explicit-any
                this._protos.google.cloud.dialogflow.v2.EntityTypes, this._opts);
        ...
        for (const methodName of entityTypesStubMethods) {
            const callPromise = this.entityTypesStub.then(stub => (...args) => {
                if (this._terminated) {
     ...
     *
     * Operation <response: {@link google.cloud.dialogflow.v2.BatchUpdateEntityTypesResponse|BatchUpdateEntityTypesResponse}>
     *
     * @param {Object} request
     *   The request object that will be sent.
     * @param {string} request.parent
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    batchUpdateEntityTypes(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        this.initialize();
        return this.innerApiCalls.batchUpdateEntityTypes(request, options, callback);
    }
    /**
     ...
     *
     */
    async checkBatchUpdateEntityTypesProgress(name) {
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    batchDeleteEntityTypes(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
        ...
        this.initialize();
        return this.innerApiCalls.batchDeleteEntityTypes(request, options, callback);
    }
    /**
     ...
     *
     */
    async checkBatchDeleteEntityTypesProgress(name) {
        const request = new google_gax_1.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    batchCreateEntities(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *
     */
    async checkBatchCreateEntitiesProgress(name) {
        const request = new google_gax_1.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    batchUpdateEntities(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *
     */
    async checkBatchUpdateEntitiesProgress(name) {
        const request = new google_gax_1.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
     ...
     *   The promise has a method named "cancel" which cancels the ongoing API call.
     */
    batchDeleteEntities(request, optionsOrCallback, callback) {
        request = request || {};
        let options;
        if (typeof optionsOrCallback === 'function' && callback === undefined) {
            callback = optionsOrCallback;
     ...
     *
     */
    async checkBatchDeleteEntitiesProgress(name) {
        const request = new google_gax_1.operationsProtos.google.longrunning.GetOperationRequest({ name });
        const [operation] = await this.operationsClient.getOperation(request);
...
//# sourceMappingURL=entity_types_client.js.map